...
// Recherche des entrées dans la table 'a_comme_specialite_principale' lors de la soumission du formulaire
if (isset($_POST['search'])) {
    ...
    $searchQuery = "SELECT * FROM a_comme_specialite_principale WHERE LOWER(id_elfe) LIKE :searchTerm OR LOWER(id_specialite) LIKE :searchTerm";
    ...
    // Si aucune recherche n'est effectuée, récupérer toutes les entrées de la table 'a_comme_specialite_principale'
    $searchQuery = "SELECT * FROM a_comme_specialite_principale";
    $conn = connexion_OCI();
    $stid = oci_parse($conn, $searchQuery);
    oci_execute($stid);
}
...
<head>
    <meta charset="UTF-8">
    <title>Gestion de La Table a_comme_specialite_principale</title>
    <style>
...
<div class="container">
    <h1>Gestion de La Table a_comme_specialite_principale</h1>
